...
public class OpenAiCaller {
     ...
     * @param apiKey The OpenAI API key (or "demo" for the LangChain4j proxy).
     * @param model The model name (e.g., "gpt-4o-mini" is required for the demo proxy).
     * @param baseUrl The base URL of the API (e.g., "https://api.openai.com/v1" or "http://langchain4j.dev/demo/openai/v1").
     */
    ...
    /**
     * Example main method for local testing using the LangChain4j demo endpoint.
     */
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Sending Request to LangChain4j Demo Proxy...");
